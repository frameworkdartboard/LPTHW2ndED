...
# ec2: current_line = 1 is passed to print_a_line and is printed
print_a_line(current_line, current_file)

# increment the counter
current_line += 1
# print the next line which matches the counter
# ec2: current_line = 1... until it's incremented by 1 then passed to print_a_line where it is printed, giving "2"
print_a_line(current_line, current_file)

# increment the counter again
current_line += 1
# print the next line which matches counter
# ec2: current_line = 2... + 1 then print_a_line giving "3"
print_a_line(current_line, current_file)
